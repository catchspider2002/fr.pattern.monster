const strings = {
  ...
  description:
    "Un générateur pour créer des motifs SVG répétables",
  description2: "Accélérez votre site sans compromettre la qualité de l'image.",
  description3: 
    "Idéal pour les fonds de site web, les vêtements, la marque, le design d'emballage et plus encore.",
  keywords:
    "motifs svg, motifs, arrière plan svg, fond d'écran vectoriel, générateur de motif, fabricant de motif",
  pages: [
    {
      page: "index",
